  ...
  return (
    <div>
      ...
      <div className="relative overflow-hidden">
        {/* before:bg-no-repeat before:w-full before:-translate-x-1/2 before:transform before:bg-top before:absolute before:top-0 before:left-1/2 before:-z-[1] before:h-full before:bg-[url('../svg/component/squared-bg-element.svg')] */}
      ...
      {/* <!-- End Hero --> */}
      quo. Accusamus accusantium ut nesciunt eligendi corporis expedita hic
      doloribus atque? Dignissimos numquam repellendus minima quis, veritatis
      quibusdam voluptates voluptatibus ullam quos debitis optio accusantium
      adipisci nihil, expedita dolores? Similique, repudiandae.
    </div>
  )
}
